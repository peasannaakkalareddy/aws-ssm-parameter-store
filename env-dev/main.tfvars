parameters = [
  ...
  { name = "dev.frontend.user_url", value = "http://user-dev.cskvsmi.online:80/" },
  { name = "dev.frontend.cart_url", value = "http://cart-dev.cskvsmi.online:80/" },
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.cskvsmi.online:80/" },
  { name = "dev.frontend.payment_url", value = "http://payment-dev.cskvsmi.online:80/" },
  ...
  { name = "dev.user.redis_host", value = "elasticache-dev-elasticache-001.ei8xum.0001.use1.cache.amazonaws.com" },
 # { name = "dev.user.mongo_url", value = "mongodb://mongodb-dev.cskvsmi.online:27017/users" },
  ...
  { name = "dev.cart.redis_host", value = "elasticache-dev-elasticache-001.ei8xum.0001.use1.cache.amazonaws.com" },
  { name = "dev.cart.catalogue_endpoint", value = "catalogue-dev.cskvsmi.online" },
  { name = "dev.cart.catalogue_port", value = "80" },
  { name = "dev.shipping.cart_endpoint", value = "cart-dev.cskvsmi.online:80" },
...
{ name = "dev.payment.AMQP_PASS", value = "roboshop123" },
  ...
  { name = "dev.user.mongo_url", value = "mongodb://roboshop:roboshop123456@docdb-dev.cluster-cfv5gvubpkmf.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false'" }
