parameters = [
  ...
  { name = "prod.user.redis_host", value = "elasticache-prod-elasticache-001.ei8xum.0001.use1.cache.amazonaws.com" },
 # { name = "prod.user.mongo_url", value = "mongodb://mongodb-prod.cskvsmi.online:27017/users" },
  ...
  { name = "prod.cart.redis_host", value = "elasticache-prod-elasticache-001.ei8xum.0001.use1.cache.amazonaws.com" },
